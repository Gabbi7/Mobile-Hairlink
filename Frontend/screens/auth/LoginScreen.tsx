...
export default function LoginScreen({
    ...
    return (
        ...
        >
            <ScrollView className="flex-1" contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                <View style={[styles.mainBox, { paddingTop: vs(20) }]}>
                    {/* Logo */}
                    <View className="w-[140px] h-[140px] justify-center items-center mb-[16px]">
